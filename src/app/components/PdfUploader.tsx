...
const PdfUploader = () => {
  ...
  return (
    <div>
      ...
      <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="navbar-start">
          ...
          <div className="dropdown">
            ...
            >
              <li><Link href="/createresume">Create my Resume</Link></li>
              <li><Link href="/uploade">Trailer my Resume</Link></li>
              <li><a onClick={handleLogout}>Sign Out</a></li>
            </ul>
          </div>

          {/* Logo */}
          <Link href="/" className="btn btn-ghost text-xl flex items-center gap-1">
            ...
            <span className="text-blue-600 text-3xl mb-1">AH</span>
            <span className="mt-2 text-yellow-500">resumeTrailer</span>
          </Link>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center bg-gray-100 p-4 gap-4">
        <div className="w-full lg:w-1/2 bg-white rounded-[40px] shadow-xl p-6">
          <div
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 ml-[20%] px-12 py-2 rounded-2xl bg-purple-800 text-white font-medium flex items-center gap-2"
          >
        ...
        <div className="w-full lg:w-1/2 bg-white rounded-[40px] shadow-xl p-6 overflow-auto">
